    ...
    rules: {
        ...
        command: $ => seq(
            ...
            choice(
                ...
                seq(
                    field("start", alias($.command_heredoc_start, SYMBOL.heredoc_start)),
                    optional(field("parts", alias($.command_heredoc_parts, $.command_parts))),
                    field("end", alias($.command_heredoc_end, SYMBOL.heredoc_end))
                )
            )
        ),
        ...
        dec_int: $ => prec.right(PREC.number, /[\+-]?\d+/),
